...
function preload() {
  img = loadImage(
    "https://images.unsplash.com/photo-1514907283155-ea5f4094c70c?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2070&q=80"
  );
}
...
function draw() {
  ...
  for (let particle of particles) {
    ...
    particle.vel.add(p5.Vector.sub(particle.target, particle.pos).div(10));
